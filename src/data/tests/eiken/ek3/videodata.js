export const videos = {
  ...
  videoContent: [
    ...
    },
    {
      ...
      longDesc:
        "単語の穴埋め問題という一見単純そうな問題ですが、その一つの問題形式の中にも、求められるスキルが複数あります。それぞれのスキルが求められる問題の割合、対策の仕方と解き方、そしてひかっけポイントを解説します。",
    },
    {
      day: "3",
      id: "3",
      ...
      longDesc:
        "筆記１穴埋め問題の中でも、単語力が求められる問題は最も割合が多い問題です。また、スペリングや似た意味など、ひっかけも多く含まれています。問題演習を通し、素早いひっかからない解き方を練習しましょう。また、分からない単語は、必ずこのレッスンを通し覚えましょう。",
    },
    {
      day: "4",
      id: "4",
    ...
    },
    {
      ...
      longDesc:
        "筆記２を解く際には、会話表現の知識と併せ文脈を理解する能力も重要となります。多くの方の悩みが文脈を理解するのに時間がかかってしまうことなので、今回の演習を通し素早く理解するコツを身につけ、筆記２だけでなく長文読解にも活かしましょう。",
    },
    {
      day: "9",
      id: "9",
    ...
    },
    {
      ...
      longDesc:
        "今回は長文読解問題の中で最初に出題される、掲示文問題の演習を行います。「掲示文」という言葉に馴染みがない方も多いかもしれませんが、今回のレッスンではそもそも「掲示文」とは何なのかも併せて例を用いて解説します。",
    },
    {
      day: "11",
      id: "11",
      ...
      longDesc:
        "今回は長文読解問題の中で２つめに出題される、Email問題の演習を行います。そもそも皆さんの日常生活の中でEmailを送ることあまり多くないかもしれませんが、どこに注目すれば良いか、などの読み方・テクニックさえわかれば、Email問題にもすぐに慣れることができるはずです。",
    },
    {
      day: "12",
      id: "12",
    ...
    },
    {
      ...
      longDesc:
        "３級の英作文には特に時間がかかってしまう方も多くいるかもしれませんが、パターンとフレーズさえ理解してしまえば素早く解くことができます。また今回のレッスンでは間違いを正す練習も行います。スピードと正確さ、両方を同時に鍛えましょう。",
    },
    {
      day: "15",
      id: "15",
    ...
    },
    {
      ...
      longDesc:
        "３級から、二次試験として面接の試験が追加となります。４技能（リーディング・ライティング・リスニング・スピーキング）の中で、スピーキングの能力は最も使う機会が少なく、緊張してしまう方も多いかもしれません。このレッスンでは試験の流れを詳しく解説するので、まずは試験と親しくなリましょう。",
    },
    {
      day: "21",
      id: "21",
